...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if update.message:
        await update.message.reply_photo(image_url, caption=caption, parse_mode="HTML", reply_markup=InlineKeyboardMarkup(keyboard))
    return GREETING
...
async def choose_role(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await query.edit_message_text(
        "<b>Напишите, пожалуйста, ваше имя или название компании, которую вы представляете</b>",
        parse_mode="HTML",
...
async def get_contact(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if role in ["applicant", "other"]:
        await update.message.reply_text("Какова ваша роль в производстве?", reply_markup=base_inline_keyboard())
    elif role == "client":
        keyboard = [
...
async def get_position(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    if update.callback_query:
        ...
        await update.callback_query.edit_message_text("Расскажите подробнее о вашем запросе:", reply_markup=base_inline_keyboard())
    else:
        position = update.message.text
        await update.message.reply_text("Расскажите подробнее о вашем запросе:", reply_markup=base_inline_keyboard())
...
async def cancel(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if update.callback_query:
        await update.callback_query.answer()
        await update.callback_query.message.reply_photo(image_url, caption=caption)
    else:
